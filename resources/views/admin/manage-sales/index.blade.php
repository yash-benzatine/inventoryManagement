                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <select type="text" id="paymentType" name="paymentType" class="form-control @error('paymentType') is-invalid @enderror" value="{{ old('paymentType') }}">
                                    ...
                                    <option value="cach" {{ old('paymentType') == 1 ? 'selected' : '' }}>cash</option>
                                    <option value="check" {{ old('paymentType') == 2 ? 'selected' : '' }}>check</option>
                                    <option value="card" {{ old('paymentType') == 3 ? 'selected' : '' }}>card</option>
                                    <!---->
                                </select>
                                @error('paymentType')
                                <div class="invalid-feedback">{{ $message }}</div>
