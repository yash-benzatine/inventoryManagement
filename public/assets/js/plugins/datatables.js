                    ...
                    (function() {
                        ...
                        var i = e(function(t, e) {
                                t.exports = (function() {
                                    var t = "millisecond",
                                        ...
                                        f = {
                                            ...
                                            p: function(d) {
                                                return ({ M: r, y: o, w: n, d: a, D: l, h: i, m: s, s: e, ms: t, Q: h }[d] ||
                                                    String(d || "")
                                                    .toLowerCase()
                                                    .replace(/s$/, "")
                                                );
                                    ...
                                    var C = (function() {
                                            ...
                                            return (
                                                ...
                                                (p.diff = function(t, l, d) {
                                                    ...
                                                    return (
                                                        (m =
                                                            ((c = {}), (c[o] = m / 12), (c[r] = m), (c[h] = m / 3), (c[n] = (g - f) / 6048e5), (c[a] = (g - f) / 864e5), (c[i] = g / 36e5), (c[s] = g / 6e4), (c[e] = g / 1e3), c)[u] || g),
                                                        d ? m : w.a(m)
                                                    );
                                                }),
                            ...
                            a = e(function(t, e) {
                                ...
                                t.exports =
                                    ((s = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }),
                                        (i = function(t, e) {
                                            return t.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function(t, i, a) {
                                                ...
                                                return (
                                                    ...
                                                    e[a] ||
                                                    s[a] ||
                                                    e[n].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function(t, e, s) {
                                                        return e || s.slice(1);
                                                    })
                                                );
                                            });
            ...
            function(t, e, s) {
                ...
                class l {
                    ...
                    order(t) {
                        ...
                        t.forEach((t, i) => {
                                ...
                                (e.sortable = r),
                                o[0].push(e),
                                    l.hiddenColumns.includes(t) || ((s = n.cloneNode(!0)), (s.originalCellIndex = i), (s.sortable = r), o[1].push(s));
                            }),
                            l.data.forEach((e, s) => {
                                (i = e.cloneNode(!1)),
                                (a = e.cloneNode(!1)),
                    ...
                    sort(e, s, i) {
                        ...
                        Promise.all(p).then((t) => {
                            ...
                            Array.from(r).forEach((t) => {
                                    ...
                                    parseFloat(a) == a ? (l[c++] = { value: Number(a), row: t }) : (o[d++] = { value: "string" == typeof i ? i.toLowerCase() : i, row: t });
                                }),
                                s || (s = u.classList.contains("asc") ? "desc" : "asc"),
                                "desc" == s ? ((p = h(o, -1)), (f = h(l, -1)), u.classList.remove("asc"), u.classList.add("desc")) : ((p = h(l, 1)), (f = h(o, 1)), u.classList.remove("desc"), u.classList.add("asc")),
                ...
                const d = function(t) {
                    ...
                    c = {
                        ...
                        hiddenHeader: !1,
                        footer: !1,
                        labels: { placeholder: "Search...", perPage: "{select} entries per page", noRows: "No entries found", info: "Showing {start} to {end} of {rows} entries" },
                    ...
                    render(t) {
                        ...
                        if (
                            (e.data && d.call(this),
                                ...
                                this.body || ((this.body = a("tbody")), this.table.appendChild(this.body)),
                        ...
                        if (
                            ((this.headings = []),
                                ...
                                e.footer ? this.head && !this.foot && ((this.foot = a("tfoot", { html: this.head.innerHTML })), this.table.appendChild(this.foot)) : this.foot && this.table.removeChild(this.table.tFoot),
                    ...
                    fixColumns() {
                        if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                            ...
                            if (((this.columnWidths = []), this.table.tHead)) {
                                if (
                                    (this.options.scrollY.length && ((e = a("thead")), e.appendChild(a("tr")), (e.style.height = "0px"), this.headerTable && (this.table.tHead = this.headerTable.tHead)),
                        ...
                        if (l.type) {
                            ...
                            if (s.length) {
                                if ("txt" === l.type || "csv" === l.type) {
                                    ...
                                    for (h = `INSERT INTO \`${l.tableName}\` (`, n = 0; n < e.length; n++)
